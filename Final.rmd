...
The odds ratio above depicts a ratio of 2.09. Therefore the males that recieved the vaccine were 
...
The odds ratio is approximately how effective the vaccine is. In order for the vaccine to be effective, we would need the. value to be atleast 50 or higher. The odds ratio for the guys can be seen above as 67.6. The effectiveness confidence interval for the males is 62.51 to 72.51. Based on the interval above, we can conclude that the vaccine is highly effective for the male population.
